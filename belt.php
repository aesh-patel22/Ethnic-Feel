...
<head>
    ...
    <title>Ethnic Feel - Waistcoat Gallery</title>
...
// SQL query to select all products (subcategory_id=23 for Waistcoat)
$sql = "SELECT id, name, image, price FROM products where subcategory_id=23 ";
