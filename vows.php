...
<head>
    ...
    <title>Ethnic Feel - Vows & Bridal Gallery</title>
...
// SQL query to select all products in the Vows/Bridal Sets category (subcategory_id=28)
$sql = "SELECT id, name, image, price FROM products where subcategory_id=28 ";
