...
<head>
    ...
    <title>Ethnic Feel - Kurta Gallery</title>
...
// SQL query to select all products (subcategory_id=22 for Kurta)
$sql = "SELECT id, name, image, price FROM products where subcategory_id=22 ";
