...
<head>
    ...
    <title>Ethnic Feel - Nehru Jacket Gallery</title>
...
// SQL query to select all products (subcategory_id=24 for Nehru Jacket)
$sql = "SELECT id, name, image, price FROM products where subcategory_id=24 ";
