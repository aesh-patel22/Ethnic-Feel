...
<head>
    ...
    <!-- JavaScript file for wishlist (optional, can be removed if not needed) -->
...
include 'header.php'; // Add the header (like menu)
...
$sql = "SELECT id, name, image, price FROM products WHERE subcategory_id = 19";
$result = mysqli_query($conn, $sql); // Get all saree products
?>
